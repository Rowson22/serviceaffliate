  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="ltalent.php">Find Talent</a></li>
        <li><a href="lwork.php">Find Work</a></li>
...
<section>
  ...
  <article>
    ...
    Standing on the River Thames, London has been a major settlement for two millennia, its history going back tans, who named it Londinium.<button onclick="location.href = 'chat/login.php';" id="myButton" class="float-left submit-button" >Select</button>
